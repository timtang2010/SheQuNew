...
-(id)initWithNameArr:(NSMutableArray *)imageArr titleArr:(NSMutableArray *)titleArr frame:(CGRect)frame
{
    ...
    if (self) {
        ...
        for (int i=0; i<imageCount; i++) {
            ...
            //创建内容对象
            AOImageView *imageView = [[AOImageView alloc]initWithImageName:[imageArr objectAtIndex:i] title:str x:frame.size.width*i y:0 height:imageSV.frame.size.height];
            //制定AOView委托
