...
#import "ProjectExpressImageView.h"
#import "UrlImageButton.h"

@implementation ProjectExpressImageView
...
- (id)initWithImageName:(NSString *)imageName title:(NSString *)titleStr x:(float)xPoint y:(float)yPoint width:(float)width height:(float)height
{
    ...
    if (self) {
        ...
        //设置背景条
        UIView *titleBack = [[UIView alloc]initWithFrame:CGRectMake(0, self.frame.size.height - 25, width, 25)];
