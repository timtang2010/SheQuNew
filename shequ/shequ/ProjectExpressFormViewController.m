//
//  ProjectExpressFormViewController.m
//  shequ
//
...
#import "ProjectExpressFormViewController.h"

#define areaRow 0
#define detailsRow 1

@interface ProjectExpressFormViewController ()
{
    NSArray *areaArrays;
...
@implementation ProjectExpressFormViewController
...
- (void)viewDidLoad
{
    ...
    NSURL *plistURL = [bundle URLForResource:@"shanghaiArea"
                               withExtension:@"plist"];
