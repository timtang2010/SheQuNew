...
- (void)viewDidLoad
{
    ...
    NSString *path = [bundle pathForResource:@"ProjectExpress" ofType:@"plist"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UITableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:CellIdntifier forIndexPath:indexPath];
